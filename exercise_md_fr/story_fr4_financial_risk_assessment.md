...
>
> **输入**:
> * `exercise_md_fr/dt_financial_risk_assessment/inputs/regulatory_requirements.md`
> * `exercise_md_fr/dt_financial_risk_assessment/inputs/transaction_data_schema.json`
> * `exercise_md_fr/dt_financial_risk_assessment/inputs/stakeholder_interviews.txt`
...
>
> **输出位置与方式**:
> * **输出目录**: `exercise_md_fr/dt_financial_risk_assessment/outputs/ExMS_10_RequirementsModel/`
...
> * (可选) `exercise_md_fr/dt_financial_risk_assessment/inputs/legacy_system_integration.md`
>
> **AI助手角色**:
...
>
> **输出位置与方式**:
> * **输出目录**: `exercise_md_fr/dt_financial_risk_assessment/outputs/ExMS_11_SystemArchitecture/`
...
>
> **输入**:
> * `exercise_md_fr/dt_financial_risk_assessment/inputs/risk_model_specs.py`
> * 本文件中的业务背景、成功标准和开发挑战 (`## 故事背景`, `## 成功标准`, `## 开发挑战`)
> * (可选) `exercise_md_fr/dt_financial_risk_assessment/inputs/regulatory_requirements.md` (关于模型解释性和公平性的要求)
>
> **AI助手角色**:
...
>
> **输出位置与方式**:
> * **输出目录**: `exercise_md_fr/dt_financial_risk_assessment/outputs/ExMS_12_AIModelEvaluation/`
...
>
> **输入**:
> * `exercise_md_fr/dt_financial_risk_assessment/inputs/security_compliance_checklist.md`
> * 本文件中的技术要求（特别是 `安全框架` 部分）和技术栈信息 (`## 技术要求`, `## 技术栈`)
> * (可选) `exercise_md_fr/dt_financial_risk_assessment/inputs/regulatory_requirements.md`
...
>
> **输出位置与方式**:
> * **输出目录**: `exercise_md_fr/dt_financial_risk_assessment/outputs/ExMS_13_SecurityAudit/`
